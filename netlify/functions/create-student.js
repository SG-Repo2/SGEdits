...
export const handler = async function (event) {
  ...
  // Diagnostic: log env var presence and first chars
  const url = process.env.SUPABASE_URL || '';
  const key = process.env.SUPABASE_SERVICE_ROLE_KEY || '';
  console.log('[create-student] SUPABASE_URL prefix:', url.slice(0, 40));
  console.log('[create-student] SERVICE_ROLE_KEY length:', key.length, 'prefix:', key.slice(0, 20));
